...
def get_landmarks(src_file):
    landmarks_detector = face_alignment.FaceAlignment(face_alignment.LandmarksType.THREE_D, flip_input=False)
    return landmarks_detector.get_landmarks(src_file)[0]


def image_align(src_file, output_size=256, transform_size=256, enable_padding=True):
        face_landmarks = get_landmarks(src_file)
