...
def image_align(src_file, dst_file, face_landmarks, output_size=256, transform_size=256, enable_padding=True):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--transform_size', default=256, type=int, help='size of aligned transform (default: 256)')
    ...
    for img_name in os.listdir(args.src):
        ...
        for i, face_landmarks in enumerate(landmarks_detector.get_landmarks(raw_img_path), start=1):
            name = f'align-{img_name}'
            aligned_face_path = os.path.join(args.dst, name)
